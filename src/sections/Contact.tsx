  ...
  const links = [
    {
      ...
      glow: "hover:shadow-[0_0_15px_#ffffff,0_0_25px_#3b82f6,0_0_35px_#1d4ed8]",
    },
    {
  ...
  return (
    ...
    >
      <div className="max-w-3xl text-center space-y-8">
        <h1
          className="reveal text-4xl font-extrabold text-blue-300"
        >
          Contact Me
        </h1>
        ...
        >
          {links.map(({ href, Icon, glow }, i) => (
            <a
              ...
              className={`border border-blue-600 text-blue-500 hover:text-white font-semibold px-6 py-3 rounded-2xl transition duration-200 ease-in-out hover:scale-[1.2] ${glow}`}
            >
