...
// rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 to-white/0
// p-4 sm:p-6 md:p-8
...
<motion.a
  variants={controlprops2 as any} 
  href="#projects"
  className="bg-transparent sm:text-lg md:text-xl text-white relative flex flex-row items-center gap-2 border border-white-400 px-6 py-3 font-sans font-bold shadow-3xl sm:shadow-lg rounded-md hover:scale-110 transition duration-300 shadow-md"
>
