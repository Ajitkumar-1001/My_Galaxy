...
const Experience: React.FC = () => {
  ...
  return (
    <section
      ref={sectionref}
      id="experience"
      className="min-h-screen flex flex-col justify-center items-center bg-transparent p-3 w-full mt-10"
    >
      <motion.div
        className="w-full max-w-6xl mx-auto px-4 mt-10 sm:px-6 lg:px-8"
        variants={hideContainer}
        initial="hidden"
        animate={control1}
      >
            ...
            >
              <div className="flex flex-col items-center justify-center mx-auto gap-6 md:flex-row md:items-start md:mx-6 md:gap-6">
                ...
                <motion.div className="flex-1" variants={motionContainr}>
                  <motion.h2
                    className="text-2xl font-sans text-center font-bold bg-gradient-to-br from-blue-950 to-sky-900 brightness-200 bg-clip-text text-transparent"
                  ...
                  <motion.div
                    className="mt-1 font-sans text-center font-bold text-sm text-gray-300 brightness-110"
                  ...
                  <motion.div className="mt-3" variants={motionContainr}>
                    <ul className="list-none space-y-1">
                      <motion.li
                        className="text-xl brightness-190 text-center font-sans font-bold bg-gradient-to-tr from-blue-500 via-white-500 to-blue-900 bg-clip-text text-transparent"
                        variants={motionContent}
                      >
                        {exp.role}
                      </motion.li>
                    ...
                    <motion.p
                      className="mt-2 text-center text-base font-sans font-semibold bg-gradient-to-br from-gray-500 to-white bg-clip-text text-transparent brightness-150"
                      variants={motionContent}
                    >
