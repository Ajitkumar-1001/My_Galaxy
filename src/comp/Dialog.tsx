...
export default function DialogDemo({source,className,button,ratio}:Demolinks) {
  return (
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-7xl md:max-w-10xl backdrop-blur bg-transparent max-h-[95vh] overflow-hidden flex flex-col">
            <div className="flex flex-col items-center flex-1 min-h-0 w-full">
                <ResponsiveIframe src={source} ratio={ratio} className="h-[85vh] md:h-auto" />
            </div>
