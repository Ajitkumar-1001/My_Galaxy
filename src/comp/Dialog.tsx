...
export default function DialogDemo({source,className,title="Project Preview"}:Demolinks) {
  return (
    
      <Dialog>
    
        <DialogTrigger asChild>
          <Button className={`w-25 h-8 bg-gradient-to-tr from-indigo-500 to-blue-800 ${className ?? ' '}`} variant="outline">Read More</Button>
        </DialogTrigger>
